        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-lg font-semibold text-gray-900">
                {landingPage.title} - Vorschau
              </h1>
              <p className="text-sm text-gray-600">
                {landingPage.is_active ? 'Veröffentlicht' : 'Entwurf'}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex gap-2">
              <button
                onClick={() => router.push(`/landingpages/${landingPageId}/einstellungen`)}
              ...
              {landingPage.is_active && (
                <button
                  onClick={() => window.open(`/landingpages/${landingPage.slug}`, '_blank')}
                  className="flex items-center gap-2 px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50"
                >
      ...
      <div className="bg-white border-t border-gray-200 p-4">
        <div className="flex items-center justify-center gap-8 text-sm text-gray-600">
          <div className="flex items-center gap-2">
            ...
            <span>Aktuell: {activeDevice === 'desktop' ? 'Desktop' : activeDevice === 'tablet' ? 'Tablet' : 'Mobil'}</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 bg-green-500 rounded-full"></div>
            <span>Responsive Design aktiv</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 bg-purple-500 rounded-full"></div>
            <span>{landingPage.blocks?.length || 0} Blöcke</span>
          </div>
        </div>
      </div>
    </div>
