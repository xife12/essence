-- =====================================================
-- Landingpages-Modul: Sichere Datenbank-Migration (Korrigiert)
-- =====================================================

-- 1. Testimonials Tabelle (falls nicht vorhanden) - OHNE campaign_id vorerst
...
-- 6. Landingpage Tabelle (falls nicht vorhanden) - OHNE campaign_id vorerst
