-- Storage Policies für privaten file-assets Bucket
...
-- Delete Policy: Nur Uploader oder Admins
...
USING (
    ...
    (
        ...
        OR
        -- Mitarbeiter nur eigene Dateien
        (
...
-- Update Policy: Nur Uploader oder Admins
